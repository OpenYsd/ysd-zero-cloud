...
void test('Phase 18 versions Agent 0.5.0 without changing Protocol 1', () => {
  assert.equal(JSON.parse(source('package.json')).version, '0.18.0');
  assert.equal(CURRENT_AGENT_VERSION, '0.5.0');
